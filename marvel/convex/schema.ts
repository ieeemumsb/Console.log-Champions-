...
export default defineSchema({
  ...
  financial_records: defineTable({
    ...
    // Status and tracking
    status: v.union(v.literal("pending"), v.literal("approved"), v.literal("completed"), v.literal("cancelled")),
  ...
  alert_logs: defineTable({
    ...
    status: v.union(v.literal("sent"), v.literal("failed"), v.literal("acknowledged")),
  ...
  reports: defineTable({
    ...
    // Status
    status: v.union(v.literal("generating"), v.literal("completed"), v.literal("failed"), v.literal("expired")),
  ...
  // Events table (keeping existing for compatibility)
  events: defineTable({
    title: v.string(),
    description: v.string(),
    date: v.string(),
