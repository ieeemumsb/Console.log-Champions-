...
export default function Analytics() {
  ...
  const generateForecast = async () => {
    ...
    try {
      ...
      const forecasts = months
        .slice(0, parseInt(forecastPeriod))
        .map((month, index) => {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground mt-1">
                Advanced financial predictions powered by artificial
                intelligence
              </p>
            </div>
          </div>
            ...
            <TabsContent value="forecast" className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <MetricCard
                  ...
                  value={
                    analyticsData.forecasts.reduce(
                      (acc, f) => acc + f.growth_rate,
                      0
                    ) / analyticsData.forecasts.length
                  }
                  format="percentage"
                  trend={
                    analyticsData.insights.revenue_trend === "increasing"
                      ? "up"
                      : analyticsData.insights.revenue_trend === "decreasing"
                        ? "down"
                        : "stable"
                  }
                ...
                <MetricCard
                  ...
                  format="number"
                  trend={
                    analyticsData.insights.key_risks.length > 3
                      ? "down"
                      : "stable"
                  }
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {analyticsData.insights.recommendations.map(
                        (rec, index) => (
                          <div
                            key={index}
                ...
                <CardContent>
                  <div className="space-y-4">
                    {analyticsData.insights.key_risks.map((risk, index) => (
                      <div
                        key={index}
                        className="flex items-start gap-3 p-4 rounded-lg border border-red-200 bg-red-50 dark:border-red-900 dark:bg-red-950/20"
                      >
            ...
            <TabsContent value="performance" className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <MetricCard
                  ...
                  format="percentage"
                  trend={
                    analyticsData.performance_metrics.volatility < 15
                      ? "up"
                      : "down"
                  }
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Click &quot;Refresh&quot; to generate AI-powered forecasts
                </p>
              </div>
            </div>
          </div>
