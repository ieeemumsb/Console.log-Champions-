...
export function MonsterStats({ currentMonsterStats }: MonsterStatsProps) {
    const healthPercentage = Math.max(0, Math.min(100, (currentMonsterStats.health / currentMonsterStats.maxHealth) * 100));
    ...
    return (
        <div className="stats-card p-6">
            <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-red-400 mb-2">{currentMonsterStats.name}</h3>
            ...
            <div className="space-y-4">
                <div>
                    <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-red-400 font-bold">{currentMonsterStats.health}/{currentMonsterStats.maxHealth}</span>
                    </div>
...
>
  <div
    className={cn("health-bar h-3 rounded-full transition-all duration-300", {
      "bg-red-500": healthPercentage < 50,
      "bg-yellow-500": healthPercentage >= 50 && healthPercentage < 75,
  ...
  ></div>
                ...
                <div className="grid grid-cols-1 gap-4 pt-4 border-t border-gray-600">
                    <div className="text-center">
                        ...
                        <div className="text-orange-400 font-bold text-xl">{currentMonsterStats.power}</div>
