...
function Store({ player, setPlayer, isOpen, onClose }: StoreProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex justify-center z-50 p-4">
      <div className="store-card rounded-2xl shadow-2xl p-8 max-w-2xl w-full max-h-[45vh] overflow-y-auto">
